...
# Wang & Deng, "WAFT: Warping-Alone Field Transforms for Optical Flow", ICLR 2026.
...
class ResNet18Deconv(nn.Module):
    def __init__(self, inp, oup):
        ...
        # Use old-style name for timm < 0.9 compatibility
        _resnet_name = "resnet18"
        for _candidate in ["resnet18.a3_in1k", "resnet18"]:
            if _candidate in timm.list_models("resnet18*"):
                _resnet_name = _candidate
                break
        _backbone = timm.create_model(_resnet_name, pretrained=True, features_only=True)
        self.conv1 = _backbone.layer1
        self.conv2 = _backbone.layer2
        self.conv3 = _backbone.layer3
        self.conv4 = _backbone.layer4
