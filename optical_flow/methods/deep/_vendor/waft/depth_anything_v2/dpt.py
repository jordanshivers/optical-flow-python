...
# Modified to support return_intermediate for WAFT integration.
...
class DPTHead(nn.Module):
    def __init__(self, in_channels, features=256, use_bn=False,
        ...
        head_features_2 = 32
        self.scratch.output_conv1 = nn.Conv2d(head_features_1, head_features_1 // 2,
    ...
    def forward(self, out_features, patch_h, patch_w, return_intermediate=False):
        out = []
        ...
        if return_intermediate:
            # Return features before output_conv2 (features//2 channels)
            # WAFT needs these intermediate features, not the 1-channel depth
